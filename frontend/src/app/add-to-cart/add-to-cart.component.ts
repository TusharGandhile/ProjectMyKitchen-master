...
(localStorage.getItem("order"))?"":this.arr=[]
  ...
  options = {
    ...
    "description": "Vender",
    "image": "https://ca.slack-edge.com/T0B4MLUM9-U02U2KSF7BQ-395b881298b2-512",
    "order_id": "",
  ...
  paynow() {
    ...
    this.options.prefill.name = "Tushar";
    this.options.prefill.email = "tusharpgandhile436@gmail.com";
    this.options.prefill.contact = "7040722842";
